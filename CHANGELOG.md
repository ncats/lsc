...
* package.json & package-lock.json to reduce vulnerabilities ([718e706](https://github.com/LabShare/lsc/commit/718e706268aa869c53cd077fe07f93067c8af840))

# [2.17.0](https://github.com/LabShare/lsc/compare/v2.16.0...v2.17.0) (2021-03-24)


### Features

* add cypress to ui template, use ngcc LSA-999 ([01e7eb5](https://github.com/LabShare/lsc/commit/01e7eb584c734adae74825ce8e8cca1166ebdd81))
...
* **logging:** add timestamp to console logs ([7994a35](https://github.com/LabShare/lsc/commit/7994a35))
...
* do build in travis and codecov ([1685156](https://github.com/LabShare/lsc/commit/1685156))
