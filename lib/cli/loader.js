 ...
 *  and/or a list of directories in options.directories. View the constructor documentation below
...
class CliLoader {
     ...
     * @param {String} [options.pattern] - The pattern used to match files containing cli commands. Default: 'cli/*.js'
    ...
    /**
     * @description Synchronously removes all the commands stored by the CLiLoader.
     */
    unload() {
        _.each(this._commands, pkg => {
